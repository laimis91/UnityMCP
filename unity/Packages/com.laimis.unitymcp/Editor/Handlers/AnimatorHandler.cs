...
{
    internal static class AnimatorHandler
    {
        internal static string BuildGetAnimatorSettingsResponse(JToken idToken, JObject root)
        {
            ...
            return UnityMcpProtocol.CreateResult(idToken, new
            {
                ...
                component = UnityMcpClient.CreateObjectSummary(animator),
                settings
            });
        }

        internal static string BuildSetAnimatorSettingsResponse(JToken idToken, JObject root)
        {
        ...
        internal static string BuildGetAnimatorParametersResponse(JToken idToken, JObject root)
        {
        ...
        internal static string BuildSetAnimatorParameterResponse(JToken idToken, JObject root)
        {
