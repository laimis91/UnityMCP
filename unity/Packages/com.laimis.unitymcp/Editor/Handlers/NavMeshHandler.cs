...
namespace UnityMcp.Editor
{
    internal static class NavMeshHandler
    {
        ...
        internal static string BuildNavMeshBakeResponse(JToken idToken)
        {
...
#pragma warning restore CS0618
        ...
        internal static string BuildGetNavMeshAgentSettingsResponse(JToken idToken, JObject root)
        {
            ...
            var (agent, ownerGo) = ResolveComponentFromInstanceId<NavMeshAgent>(instanceId, "navMeshAgent.getSettings");
        ...
        internal static string BuildSetNavMeshAgentSettingsResponse(JToken idToken, JObject root)
        {
            var paramsObject = RequireParamsObject(root, "navMeshAgent.setSettings");
            var instanceId = ParseRequiredIntegerParameter(paramsObject, "instanceId");
            var (agent, ownerGo) = ResolveComponentFromInstanceId<NavMeshAgent>(instanceId, "navMeshAgent.setSettings");
            ...
            { agent.obstacleAvoidanceType = ParseEnumToken<ObstacleAvoidanceType>(oat, "obstacleAvoidanceType"); applied.Add("obstacleAvoidanceType"); }
        ...
        internal static string BuildGetNavMeshObstacleSettingsResponse(JToken idToken, JObject root)
        {
            var paramsObject = RequireParamsObject(root, "navMeshObstacle.getSettings");
            var instanceId = ParseRequiredIntegerParameter(paramsObject, "instanceId");
            var (obstacle, ownerGo) = ResolveComponentFromInstanceId<NavMeshObstacle>(instanceId, "navMeshObstacle.getSettings");
        ...
        internal static string BuildSetNavMeshObstacleSettingsResponse(JToken idToken, JObject root)
        {
            var paramsObject = RequireParamsObject(root, "navMeshObstacle.setSettings");
            var instanceId = ParseRequiredIntegerParameter(paramsObject, "instanceId");
            var (obstacle, ownerGo) = ResolveComponentFromInstanceId<NavMeshObstacle>(instanceId, "navMeshObstacle.setSettings");
            ...
            { obstacle.shape = ParseEnumToken<NavMeshObstacleShape>(shapeToken, "shape"); applied.Add("shape"); }
