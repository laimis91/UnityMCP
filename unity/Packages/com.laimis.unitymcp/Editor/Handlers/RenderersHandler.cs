...
internal static class RenderersHandler
{
    // ── Renderer Materials ──────────────────────────────────────────────

    internal static string BuildGetRendererMaterialsResponse(JToken idToken, JObject root)
    {
    ...
    internal static string BuildSetRendererMaterialResponse(JToken idToken, JObject root)
    {
    ...
    internal static string BuildGetMeshRendererSettingsResponse(JToken idToken, JObject root)
    {
    ...
    internal static string BuildSetMeshRendererSettingsResponse(JToken idToken, JObject root)
    {
    ...
    internal static string BuildGetSkinnedMeshRendererSettingsResponse(JToken idToken, JObject root)
    {
    ...
    internal static string BuildSetSkinnedMeshRendererSettingsResponse(JToken idToken, JObject root)
    {
    ...
    internal static string BuildGetSpriteRendererSettingsResponse(JToken idToken, JObject root)
    {
    ...
    internal static string BuildSetSpriteRendererSettingsResponse(JToken idToken, JObject root)
    {
    ...
    internal static string BuildGetLineRendererSettingsResponse(JToken idToken, JObject root)
    {
    ...
    internal static string BuildSetLineRendererSettingsResponse(JToken idToken, JObject root)
    {
    ...
    internal static string BuildGetLODGroupSettingsResponse(JToken idToken, JObject root)
    {
    ...
    internal static string BuildSetLODGroupSettingsResponse(JToken idToken, JObject root)
    {
