...
namespace UnityMcp.Editor
{
    internal static class UIHandler
    {
        ...
        internal static string BuildGetRectTransformSettingsResponse(JToken idToken, JObject root)
        {
            ...
            {
                target = UnityMcpClient.CreateObjectSummary(ownerGo),
                component = UnityMcpClient.CreateObjectSummary(rt),
                settings
            });
        }

        internal static string BuildSetRectTransformSettingsResponse(JToken idToken, JObject root)
        {
        ...
        internal static string BuildGetCanvasSettingsResponse(JToken idToken, JObject root)
        {
            ...
            {
                target = UnityMcpClient.CreateObjectSummary(ownerGo),
                component = UnityMcpClient.CreateObjectSummary(canvas),
                settings
            });
        }

        internal static string BuildSetCanvasSettingsResponse(JToken idToken, JObject root)
        {
        ...
        internal static string BuildGetCanvasGroupSettingsResponse(JToken idToken, JObject root)
        {
            ...
            var result = new
            {
                target = UnityMcpClient.CreateObjectSummary(canvasGroup.gameObject),
                component = UnityMcpClient.CreateObjectSummary(canvasGroup),
                settings = new
                {
        ...
        internal static string BuildSetCanvasGroupSettingsResponse(JToken idToken, JObject root)
        {
